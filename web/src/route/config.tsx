...
import { Home, Radio, Sparkles, FolderTree, GitBranch, Settings, Logs } from 'lucide-react';
...
const Route_Module = lazyWithPreload(() => import('@/components/modules/route').then(m => ({ default: m.Route })));
...
export const ROUTES: RouteConfig[] = [
    ...
    { id: 'route', label: 'Route', icon: GitBranch, component: Route_Module },
