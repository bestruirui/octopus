...
import { Home, Radio, Sparkles, FolderTree, Settings, Logs, ActivitySquare } from 'lucide-react';
...
export const ROUTES: RouteConfig[] = [
    ...
    { id: 'health', label: 'Health', icon: ActivitySquare, component: Health_Module },
